...
f = open(root + "Experiments/Results/VGG_kaggle_train.txt", "w")
g = open(root + "Experiments/Results/VGG_kaggle_test.txt", "w")
...
with tf.Session() as sess:
    ...
    while ITERATIONS > 0:
        ...
        if ITERATIONS % 200 == 0:
            saver.save(sess, root + 'Experiments/Models/VGG_kaggle_model')
f.close()
g.close()
