...
u = VGG_graph.VGG_bird_multilayer(net)
...
f = open(root + "Experiments/Results/VGG_bird_multilayer_train_log_conv5_5.txt", "w")
g = open(root + "Experiments/Results/VGG_bird_multilayer_test_log_conv5_5.txt", "w")
...
with tf.Session() as sess:
    ...
    while ITERATIONS > 0:
        batch_x,batch_point_x,batch_point_y,batch_existence = VGG_utils.get_next_trn_batch_multilayer_bird(train_data)
        ...
        if ITERATIONS % 30 == 0:
            ...
            error = 0; l2 = 0;
            for i in range(10):
                batch_x,batch_point_x,batch_point_y,batch_existence = VGG_utils.get_next_trn_batch_multilayer_bird(test_data)
        ...
        if ITERATIONS % 200 == 0:
            saver.save(sess, root + 'Experiments/Models/VGG_bird_multilayer_model_conv5_5_newest')
f.close()
g.close()
