...
u = VGG_graph.VGG_face_scratch_point_detection_net(net)
...
f = open(root + "Experiments/Results/VGG_face_scratch_train_fixed_log_conv5_5.txt", "w")
g = open(root + "Experiments/Results/VGG_face_scratch_test_fixed_log_conv5_5.txt", "w")
...
with tf.Session() as sess:
    ...
    while ITERATIONS > 0:
        ...
        if ITERATIONS % 200 == 0:
            saver.save(sess, root + 'Experiments/Models/VGG_face_scratch_model_conv5_5_fixed')
f.close()
g.close()
